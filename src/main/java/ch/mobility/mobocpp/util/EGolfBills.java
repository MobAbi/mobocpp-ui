...
public class EGolfBills {
    ...
    public static final double EGOLF_LONGITUDE = 46.97472;
    public static final double EGOLF_LATITUDE =   8.41849;
    public static final double EGOLF_LONGITUDE_EXAKT = 46.97473170278975;
    public static final double EGOLF_LATITUDE_EXAKT = 8.418418517873619;
